...
export const PodcastBanner: React.FC<PodcastBannerProps> = ({
    title, link, enclosure, date, duration, summary, artworkUrl,
}) => {
        ...
        <div className="vvp-co__podcast-banner">
            <div className="vvp-co__podcast-inner">
                ...
                <div className="vvp-co__podcast-content">
                    ...
                    <a href={link} className="vvp-co__podcast-title" target="_blank" rel="noopener noreferrer">
                        {title}
                    </a>

                    {summary && (
                        <p className="vvp-co__podcast-summary">{summary}</p>
                    )}
